...
| `resourcePaths` | raíces con `System/`, `Textures/`, `Sounds/`, `StaticMeshes/`, `Animations/` que contienen contenido propio, paquetes de dependencias ya compilados y los `.ini` de paquete que se compilan dentro del build |
