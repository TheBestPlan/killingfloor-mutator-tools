...
| `resourcePaths` | racines contenant `System/`, `Textures/`, `Sounds/`, `StaticMeshes/`, `Animations/` avec le contenu personnalisé, les paquets de dépendances déjà compilés et les `.ini` de paquet intégrés à la compilation |
